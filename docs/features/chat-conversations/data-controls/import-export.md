...
FlowChat provides tools to backup your chat history and restore it later, or migrate conversations from other platforms.
...
Click the **Import Chats** button and select a JSON file to restore conversations. FlowChat supports importing from:

- **FlowChat exports**: Native JSON format from previous exports
...
**A:** Currently, native import support is available for FlowChat and ChatGPT formats. Other platforms may require manual conversion to the expected JSON structure.
